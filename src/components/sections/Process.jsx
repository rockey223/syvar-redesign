  ...
  return (
    ...
    >
      <div className="process_wrapper  flex flex-col lg:flex-row lg:justify-between max-lg:px-[30px] xl:pb-0 2xl:pb-[100px] pb-[100px]">
        {/* Left Section */}
        <div className="left w-full lg:w-1/2 xl:w-1/2 max-h-[1000px] lg:h-screen flex  ">
          <div className="process_left_content_wrapper xl:pl-[60px] lg:pl-[60px] pt-[60px]">
            ...
            {processes.map((process, index) => (
              <React.Fragment key={process.title + index}>
                ...
                >
                  ...
                  <p className="mpoint m_heading lg:hidden text-xl md:text-3xl  mb-2 font-semibold">
                    {`0${index + 1} ${process.title}`}
                  </p>
                    {process.points.map((point, index) => (
                      <p
                        key={point}
                        className="mpoint text-lg lg:text-[24px] xl:leading-[20px] 2xl:leading-[20px] "
                      >
                        {point}
                      </p>
                    ))}
                ...
                <hr
                  className={`mpoint Line lg:ml-[10px] xl:ml-[60px] ${
