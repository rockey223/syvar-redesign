...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="max-w-[1920px] max-h-[900px] h-screen bg-black w-[100.01%] fixed bottom-0 right-1/2 translate-x-1/2 -z-10 px-[30px] lg:px-[60px] xl:px-[60px] py-[80px]">
